...
public class PlaylistDAO extends CassandraData {
  ...
  public static class PlaylistTrack {
    ...
    public PlaylistTrack(Row row) {
      ...
      this.sequence_no = new Date(row.getDate("sequence_no").getMillisSinceEpoch());
  ...
  public void addTrackToPlaylist(PlaylistTrack playlistTrack) {
    ...
    boundStatement.setDate("sequence_no", LocalDate.fromDaysSinceEpoch((int)playlistTrack.sequence_no.getTime()/(1000*3600)));
